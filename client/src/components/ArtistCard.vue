...
<template>
    <div class="card d-flex flex-column align-items-center" style="width: 14rem;">
        <h5 class="my-2 mx-3 text-center">{{ props.artist.name }}</h5>
        <a :href="props.artist.external_urls.spotify" target="_blank" class="text-decoration-none text-dark">
            <img :src="props.artist.images[0].url" class="mb-3" alt="Artist Image"
                style="width: 12rem; height: 12rem; box-shadow: 0px 0px 30px rgba(0, 0, 0, 1);">
        </a>
